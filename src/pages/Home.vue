<template>
    ...
    <div class="container-fluid">
      ...
      <div class="tab-content tab-content-carousel">
        <div class="tab-pane p-0 fade show active" id="hot-all-tab" role="tabpanel" aria-labelledby="hot-all-link">
          <div class="owl-carousel owl-simple row carousel-equal-height carousel-with-shadow row" data-toggle="owl"
               data-owl-options='{
                                    "nav": false,
                                    "dots": true,
                                    "margin": 20,
            ...
            <div class="product col-md-3 col-lg-2">
              ...
              <div class="product-body">
                ...
                </div><!-- End .rating-container-fluid -->
  ...
  <div class="container-fluid furniture">
    <div class="heading heading-flex heading-border mb-3">
      <div class="heading-left">
  ...
  <div class="blog-posts bg-light pt-4 pb-7">
    <div class="container-fluid">
      ...
      <div class="owl-carousel owl-simple row" data-toggle="owl"
           data-owl-options='{
                            "nav": false,
                            "dots": true,
                            "items": 3,
        ...
        <article class="entry col-md-4 col-lg-3">
